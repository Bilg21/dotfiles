...
-- Input Language - Text Label
--local kbdcfg = keyboard_layout.kbdcfg({type = "tui"})
--kbdcfg.add_primary_layout("English", "US", "us")
--kbdcfg.add_primary_layout("Mongolian", "MN", "mn")
--kbdcfg.bind()

-- Input Language - Icon
local kbdcfg = keyboard_layout.kbdcfg({type = "gui"})
kbdcfg.add_primary_layout("English", "/home/bilg/.config/awesome/keyboard_layout/icons/en.png", "us")
kbdcfg.add_primary_layout("Mongolian", "/home/bilg/.config/awesome/keyboard_layout/icons/mn.png", "mn")
kbdcfg.bind()
...
globalkeys = awful.util.table.join(globalkeys, 
	awful.key({ "Mod1", "Shift" }, "Up", function () kbdcfg.switch_next() end)
)
